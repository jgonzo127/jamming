    ...
    render() {
        ...
        return(
            <div className="TrackList">
                { 
                    tracks.map( track => 
                        <Track key={this.props.tracks[track].id} id={this.props.tracks[track].id} name={this.props.tracks[track].name} uri={this.props.tracks[track].uri} artist={this.props.tracks[track].artist} album={this.props.tracks[track].album} index={this.props.tracks[track].index} preview={this.props.tracks[track].preview} onAdd={this.props.onAdd} addedTracks={this.props.addedTracks} onRemove={this.props.onRemove} />
